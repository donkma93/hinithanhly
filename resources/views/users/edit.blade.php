                    ...
                    @can('users.delete')
                        <div class="mt-6 border-t border-gray-200 pt-5">
                            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                <p class="text-sm text-gray-500">Thao tác này sẽ đưa tài khoản vào thùng rác thay vì xóa hẳn.</p>
                                <x-confirm-action
                                    :name="'delete-user-'.$user->public_id"
                                    :action="route('users.destroy', $user)"
                                    title="Đưa tài khoản vào thùng rác"
                                    message="Bạn có chắc chắn muốn đưa tài khoản này vào thùng rác?"
